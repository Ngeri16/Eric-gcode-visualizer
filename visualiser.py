...
class GCodeVisualizer:
    """
    Visualizes G-code toolpath in 3D.

    Usage:
        vis = GCodeVisualizer("my_print.gcode")
        vis.plot()
    """
    ...
    def plot(self):
        ...
        # Track current position (G-code is stateful)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) >= 2:
        ...
        # Use a built-in sample so you can test without a real .gcode file
        sample = """\
